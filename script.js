...
/* ── Activate Engine — one click anywhere fires toast only ── */
(function () {
  let activated = false;
  ...
  function activateEngine() {
    if (activated) return;
    activated = true;
    showToast('Engine activated — happy training!', 3500);
  }

  document.addEventListener('click', activateEngine, { once: true });
})();
